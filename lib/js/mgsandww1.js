...
(function() {
  ...
  mgsAndWw1Site.controller("doQuery", function($scope) {
    // TODO: Show hamburger by default on all columns
    // TODO: Add custom rank filter
    ...
    var columnDefs = [
      ...
      {headerName: "Military details",
        children: [
          {headerName: "Rank", field: "rank", filter: "supressFilter"},
          {headerName: "Service number", field: "serviceNumber", filter: "supressFilter"},
  ...
  mgsAndWw1Site.controller("viewRecord", function($scope, $routeParams) {
    ...
    // TODO: Insert a README to the JSON file
...
// TODO: Add static pages, generated dynamically from MD
